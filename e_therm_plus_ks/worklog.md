...
2026-07-15 - v2.6.209 - Autore: Codex
- Termostati Guest: pagina camera aggiornata live via SSE/polling per stato, temperatura e setpoint.
- Le card guest sono grigie se spente, arancio con caldo acceso e celesti con freddo acceso.
- File modificati: app/debug_server.py, app/main.py, config.yaml, README_ADDON.md, worklog.md, CHANGELOG.md.
...
2026-07-15 - v2.6.206 - Autore: Codex
- Configurazione vTherm: aggiunti flag `Guest` e campo `Nome stanza guest` nella modifica termostato.
- Pagina `Termostati Guest`: ora include solo i termostati marcati manualmente come guest.
- File modificati: app/debug_server.py, app/main.py, config.yaml, README_ADDON.md, worklog.md, CHANGELOG.md.
...
2026-07-09 - v2.6.200 - Autore: Codex
- Dettaglio termostato: il pomello setpoint viene renderizzato gia' nella posizione iniziale corretta lato server, evitando il salto appena si apre la pagina.
- Allineato il calcolo HTML/JavaScript del raggio del pomello in percentuale, cosi' il primo render e il successivo aggiornamento live non si correggono a vicenda.
- File modificati: app/debug_server.py, app/main.py, config.yaml, README_ADDON.md, worklog.md, CHANGELOG.md.

---

2026-07-09 - v2.6.199 - Autore: Codex
- Dettaglio termostato: separato il valore numerico iniziale del setpoint dal testo localizzato (`18,5`) usato a video.
- Il pomello viene posizionato subito dopo il wiring del ring, prima del render live completo.
- File modificati: app/debug_server.py, app/main.py, config.yaml, README_ADDON.md, worklog.md, CHANGELOG.md.
...
2026-07-09 - v2.6.196 - Autore: Codex
- Dettaglio termostato: il drag del setpoint ora usa delta angolari incrementali tra eventi pointer, evitando salti quando il cursore attraversa la giunzione del cerchio.
- Durante il drag anche la label centrale del setpoint resta controllata dalla preview locale, non dal render live.
- File modificati: app/debug_server.py, app/main.py, config.yaml, README_ADDON.md, worklog.md, CHANGELOG.md.
...
- Aggiunta pagina `/computherm` e nuova voce nel menu principale.
- Runtime: lettura sensori `CSSensors`, refresh I/O, snapshot UI e pubblicazione MQTT Discovery sensori.
- Aggiornata UI_REV a `2026-06-23.C`.
- File modificati: app/debug_server.py, app/main.py, config.yaml, README_ADDON.md, worklog.md.
...
- Aggiornata UI_REV a `2026-06-22.D`.
- File modificati: app/debug_server.py, app/main.py, config.yaml, README_ADDON.md, worklog.md.
...
- Aggiornata UI_REV a `2026-06-22.B`.
- File modificati: app/debug_server.py, app/main.py, config.yaml, README_ADDON.md, worklog.md.
